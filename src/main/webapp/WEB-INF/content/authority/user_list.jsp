    ...
    <div class="panel panel-default">
      ...
      <div class="form-inline popover-show panel-body list_toolbar">
        <div class="form-group    width_input"  data-toggle="popover"  data-placement="top" data-content="请输入用户名">
          <input  class="form-control" type="text"  placeholder="用户名" name="searchUser.userName" value="${searchUser.userName}"/>
        </div>
        <div class="form-group    width_input"  data-toggle="popover"  data-placement="top" data-content="请输入真实姓名">
          <input  class="form-control" type="text"  placeholder="真实姓名" name="searchUser.realName" value="${searchUser.realName}"/>
        </div>
        <div class="form-group    width_input"  data-toggle="popover"  data-placement="top" data-content="请选择角色">
          <select size="1" class="form-control" name="searchUser.roleID">
            ...
            <s:iterator value="roleList" var="role">
				<option <s:if test="searchUser.roleID==#role.id">selected</s:if> value="${role.id }">${role.roleName }</option>
			</s:iterator>
          </select>
        </div>
        <div class="form-group width_input"  data-toggle="popover"  data-placement="top" data-content="请选择状态">
          <mt:selectState name="searchUser.state" showType="select" stateType="userState" value="${searchUser.state}" clazz="form-control" emptyString="--请选择状态--"/>
        </div>
        ...
        <table class="table table-hover table-striped table-bordered table-condensed table-big">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><mt:selectState showType="label" value="${tempUser.state}" stateType="userState"/></td>
              ...
              <td><div class="btn-group btn-group-sm pull-right">
                  ...
                  <ul class="dropdown-menu" role="menu">
                    ...
                    <li><a href="javascript:confirmAction('user_disabled.shtml?audit=-1&checkedIds=${tempUser.id }','您确认删除？');">删除</a></li>
                    <li role="presentation" class="divider"></li>
                    <li><a href="javascript:confirmAction('user_disabled.shtml?audit=0&checkedIds=${tempUser.id }','您确认启用？');">启用</a></li>
                    <li><a href="javascript:confirmAction('user_disabled.shtml?audit=1&checkedIds=${tempUser.id }','您确认禁用？');">禁用</a></li>
                    <li role="presentation" class="divider"></li>
					<li><mt:modalDialog remote="/history/history_list.shtml?history.rid=${tempUser.id}&history.omkey=user&t=${r}" id="historyWindow${tempUser.id}" title="历史记录" role="dialog" name="历史记录" type="link" width="700"/></li>
                  </ul>
                </div></td>
            </tr>
            	</s:iterator>
