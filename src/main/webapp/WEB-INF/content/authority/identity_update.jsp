...
<body class="fix_top_nav_padding">
	...
	<div class="container">
	    <ol class="breadcrumb row">
	      ...
	      <li class="active">修改身份</li>
	    </ol>
	    <div class="panel panel-default">
	      <div class="panel-heading ">
	        <h3 class="panel-title">修改身份</h3>
	      </div>
			<style type="text/css">
				fieldset {
				...
				<div class="panel-body ">
		          <div class=" tooltip-show form-horizontal">
		              ...
		              <div class=" col-sm-9 col-lg-5">
		                <input  class="form-control" type="text" id="name" name="identity.name" maxlength="50" value="<s:property value="identity.name"/>"  placeholder="请输入身份名称"/>
		              </div>
		            ...
		            <div class="form-group clearfix" >
		              ...
		              <div class=" col-sm-9  col-lg-5">
		                <textarea class="form-control" name="identity.description" id="identity.description" rows="4"><s:property value="identity.description.replace('<br/>','\r\n')" escape="false"/></textarea>
		              </div>
		              		...
		              		<fieldset>
			                	...
			                	<fieldset>
		                            ...
		                            <s:iterator value="games" var="game">
		                            	<input type="checkbox" name="gameIds" <c:if test="${game.isAuth == 1 }">checked</c:if> lang="game" value="${game.id }"/>&nbsp;${game.appName }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		                            </s:iterator>
		                     	</fieldset>
		                    </fieldset>
		              	</c:if>
	...
	$(document).ready(function() {
		$("#inputForm").validate({
			submitHandler: function(form){
				$.ajax({
					url: "identity_checkIdentityName.shtml?name="+$('#name').val()+"&id="+$('#roleid').val(),
					type: "post",
