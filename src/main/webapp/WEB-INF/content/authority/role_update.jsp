				...
				<div class="panel-body ">
		          <div class=" tooltip-show form-horizontal">
		            ...
		            <div class="form-group clearfix" >
		              ...
		              <div class=" col-sm-9  col-lg-5">
		                <textarea class="form-control" name="role.description" id="role.description" rows="4"><s:property value="role.description.replace('<br/>','\r\n')" escape="false"/></textarea>
		              </div>
	...
	$(document).ready(function() {
		$("#inputForm").validate({
			submitHandler: function(form){
				$.ajax({
					url: "role_checkRoleName.shtml?roleName="+$('#roleName').val()+"&id="+$('#roleid').val(),
					type: "post",
