          				...
          				<c:if test="${result['isCompare'] == 0 }">
	          				<s:if test="result['data'].size > 0">
								...
								<s:iterator value="result['data']" var="item">
									<s:set var="allonlineUsers" value="#allonlineUsers + #item.onlineUsers"></s:set>
			          				<s:set var="allroleUsers" value="#allroleUsers + #item.roleUsers"></s:set>
			          				<s:set var="allnewDevices" value="#allnewDevices + #item.newDevices"></s:set>
			          				<s:set var="allpayAmount" value="#allpayAmount + #item.payAmount"></s:set>
			          				<s:set var="allactiveUsers" value="#allactiveUsers + #item.activeUsers"></s:set>
							...
							<s:if test="result['data'].size > 0">
								...
								<s:iterator value="result['data']" var="item" >
									<s:iterator value="#item.value" var="itemVal" status="st">
										<s:set var="addonlineUsers" value="#addonlineUsers + #itemVal.onlineUsers"></s:set>
				          				<s:set var="addroleUsers" value="#addroleUsers + #itemVal.roleUsers"></s:set>
				          				<s:set var="addnewDevices" value="#addnewDevices + #itemVal.newDevices"></s:set>
				          				<s:set var="addpayAmount" value="#addpayAmount + #itemVal.payAmount"></s:set>
				          				<s:set var="addactiveUsers" value="#addactiveUsers + #itemVal.activeUsers"></s:set>
								...
								<tr>
			          				<td>合计</td>
			          				<td></td>
			          				<td><fmt:formatNumber  value="${addonlineUsers/dateSize }" pattern="0" />(平均)</td>
				                    <td>${addroleUsers }</td>				
				                    <td>${addnewDevices }</td>
								...
								<s:iterator value="result['data']" var="item" >
									...
									<s:set var="dataSize" value="0"></s:set>
				          			...
				          			<s:iterator value="#item.value" var="itemVal" status="st">
				          				<s:set var="allonlineUsers" value="#allonlineUsers + #itemVal.onlineUsers"></s:set>
				          			...
				          			<s:if test="#item.value.size >1">
				          				<tr>
					          				<td>合计</td>
					          				<td><fmt:formatNumber  value="${allonlineUsers/dataSize }" pattern="0" />(平均)</td>
						                    <td>${allroleUsers }</td>				
						                    <td>${allnewDevices }</td>
						                    <td><fmt:formatNumber  value="${allpayAmount/100 }" pattern="0.00" /></td>
