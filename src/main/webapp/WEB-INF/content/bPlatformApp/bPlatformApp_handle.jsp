...
<body class="fix_top_nav_padding">
	...
	<div class="container">
	    <ol class="breadcrumb row">
	      ...
	      <li><a href="${ctx}/bPlatformApp/bPlatformApp_list.shtml">联运游戏关联列表</a></li>
	      <s:if test="id==null">
	      <li class="active">新增联运游戏关联信息</li>
	      </s:if>
	      <s:else>
	      <li class="active">修改联运游戏关联信息</li>
	      </s:else>
	    </ol>
	    <div class="panel panel-default">
	      	<div class="panel-heading ">
	        	<h3 class="panel-title">${id==null?"新增":"修改"}联运游戏关联信息</h3>
	      	</div>
	        	...
	        	<div class="panel-body ">
	          		<div class=" tooltip-show form-horizontal">
						...
						<div class="form-group clearfix" >
							<label  class="control-label col-sm-3 col-lg-2 text-right"><b class="color_red">*</b>联运平台：</label>
					...
					<div class="form-group clearfix" >
							<label  class="control-label col-sm-3 col-lg-2 text-right"><b class="color_red">*</b>联运游戏：</label>
							<div class=" col-sm-9 col-lg-5">
								<c:if test="${id == null }">
