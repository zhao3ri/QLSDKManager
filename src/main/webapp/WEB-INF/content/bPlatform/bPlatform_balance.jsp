...
<body class="fix_top_nav_padding">
	...
	<div class="container">
	    ...
	    <div class="panel panel-default">
	      	...
	      	<form identity="form" id="inputForm" action="bPlatform_addOrder.shtml" method="post">
	        	<div class="panel-body ">
	          		<div class=" tooltip-show form-horizontal">
						...
						<div class="form-group clearfix" >
							...
							<div class=" col-sm-9 col-lg-5">
							<input class="form-control" type="number" id="bPlatform.amount" name="BPlatform.amount"   placeholder="请输入金额"/>
							<label id="platformNameinfo"></label>
							</div>
						</div>
