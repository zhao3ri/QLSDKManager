    ...
    <%
        ...
        if (pageObj != null && pageObj.getResult().size() > 0) {
            if (pageObj.getPageNo() == 1)
                out.print("<li class=\"disabled\"><span title=\"首页\"><i class=\"icon-step-backward\"></i></span></li>");
            else
                out.print("<li><a href=\"javascript:jumpPage(1)\" title=\"首页\"><i class=\"icon-step-backward\"></i></a></li>");
            if (pageObj.isHasPre())
                out.print("<li><a href=\"javascript:jumpPage(" + pageObj.getPrePage() + ")\"  title=\"上一页\"><i class=\"icon-chevron-left\"></i></a></li>");
            else
                out.print("<li class=\"disabled\"><span title=\"上一页\"><i class=\"icon-chevron-left\"></i></span></li>");
            ...
            if (pageObj.isHasNext())
                out.print("<li><a href=\"javascript:jumpPage(" + pageObj.getNextPage() + ")\" title=\"下一页\"><i class=\"icon-chevron-right\"></i></a></li>");
            else
                out.print("<li class=\"disabled\"><span title=\"下一页\"><i class=\"icon-chevron-right\"></i></span></li>");
            if (pageObj.getPageNo() == pageObj.getTotalPages() || pageObj.getTotalCount() == 0)
                out.print("<li class=\"disabled\"><span title=\"末页\"><i class=\"icon-step-forward\"></i></span></li>");
            else
                out.print("<li><a href=\"javascript:jumpPage(" + pageObj.getTotalPages() + ")\"  title=\"末页\"><i class=\"icon-step-forward\"></i></a></li>");
