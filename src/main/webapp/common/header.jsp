    ...
    <nav class="navbar navbar-default navbar-static-top row" role="navigation"> 
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav  navbar-right">
          <li class="text-center">
            <div class="btn-group navbar-btn tooltip-show">
              <div class="btn-group ">
                <button type="button" class="btn btn-default  dropdown-toggle" data-toggle="dropdown" ><i class="icon-user "></i><span class="badge badge-nobg">${sessionUserInfo==null?session.sessionUser:session.sessionUserInfo.realName }</span> <b class="caret"></b> </button>
                <ul  class="dropdown-menu text-left">
                  <li><a href="${ctx}/user/user_updateMyInfo.shtml?user.id=${sessionUserInfo.id }"><i class="icon-user"></i> 个人资料</a></li>
                  <li><a href="${ctx}/user/user_updateMyPassword.shtml?user.id=${sessionUserInfo.id }"><i class="icon-key"></i> 修改密码</a></li>
        ...
        <ul class="nav  nav-pills navbar-form  navbar-left">
	          ...
	          <mt:auths authUrls="user_list.shtml,role_list.shtml,module_list.shtml,function_list.shtml,data_list.shtml,dictionary_list.shtml,systool_cleanCache.shtml">
	          <li class="menuTop dropdown <% out.print(getSelected("authority,dictionary,history,systool")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">系统管理<b class="caret"></b></a>
		   ...
		   <mt:auths authUrls="bPlatform_list.shtml,bPlatformApp_list.shtml">
	            <li class="menuTop dropdown <% out.print(getSelected("bPlatform")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">联运平台管理<b class="caret"></b></a>
		           <ul class="dropdown-menu">
           ...
           <li class="menuTop dropdown <% out.print(getSelected("bGame")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">游戏管理<b class="caret"></b></a>
                   <ul class="dropdown-menu">
            ...
            <mt:auths authUrls="bOrder_list.shtml">
	            <li class="menuTop dropdown <% out.print(getSelected("bOrder")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">充值管理<b class="caret"></b></a>
		           <ul class="dropdown-menu">
           ...
           <mt:auths authUrls="report_summary.shtml">
	            <li class="menuTop dropdown <% out.print(getSelected("report")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">报表管理<b class="caret"></b></a>
		           <ul class="dropdown-menu">
           ...
           <mt:auths authUrls="roleReport_realTimeLogin.shtml">
	            <li class="menuTop dropdown <% out.print(getSelected("roleReport")); %>"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">报表管理2<b class="caret"></b></a>
		           <ul class="dropdown-menu">
