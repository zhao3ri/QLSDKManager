...
<!-- 全局脚本 -->
<!-- 页面脚本 -->
<script type="text/javascript" src="/js/plugins/bootstrap-switch/js/bootstrap-switch.min.js"></script>
<!-- bootstrap-switch切换开关 -->
<!-- 日期选择插件 -->
<script type="text/javascript" src="/js/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"
        charset="UTF-8"></script>
<script type="text/javascript" src="/js/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"
        charset="UTF-8"></script>
