...
public class ApplicationListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		try {
			...
			// 加载配置信息
			String appFile = event.getServletContext().getRealPath("") + "/WEB-INF/classes/application.properties";
			PropertyUtils.loadFile(appFile);
			
			 
			Constants.CONTEXT_PATH = PropertyUtils.get("base.url");
			...
			//初始化话状态内容
			StateContext.initStateConfigs(event.getServletContext().getRealPath("")+"/WEB-INF/classes/state.xml");
