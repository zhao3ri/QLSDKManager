 ...
 * [Project:RealeaseSdkManage,Id:SChannel.java  2014-12-25 17:12:37 zhouxb ]
 */
 ...
 */
 public class SChannelDaily {
	...
	public String toString() {
		return "SChannelMonthly [id=" + id + ", clientType=" + clientType
				+ ", gameId=" + gameId + ", gameName=" + gameName + ", channelId="
				+ channelId + ", channelName=" + channelName
				+ ", totalRoleUser=" + totalRoleUser + ", totalRegUser="
				+ totalRegUser + ", devices=" + devices + ", payAmount="
				+ payAmount + ", payTimes=" + payTimes + ", payUsers="
				+ payUsers + "]";
	}
}